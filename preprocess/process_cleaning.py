...
def filter_amt_to_round_3():
    amt_dict = {
        'MBANK_TRNFLW': ['TFT_TRNAMT'],
        'EBANK_CSTLOG': ['TRNAMT'],
        'APS': ['APSDTRAMT'],
        'CUST_FA_SUM': ['DAY_FA_BAL', 'MAVER_FA_BAL', 'SAVER_FA_BAL', 'YAVER_FA_BAL',
        ...
        'DP_CUST_SUM': ['DPSA_BAL', 'MAVER_DPSA_BAL', 'SAVER_DPSA_BAL', 'YAVER_DPSA_BAL',
    ...
    for k, v in amt_dict.items():
        ...
        exporter.export_df_to_test(f'{k}', test)
